...
# 0. CONFIGURATION
# ==========================================
TARGET_FPS = 15      # Speed: How many steps per second (e.g., 10, 30, 60)
BRIGHTNESS = 0.5     # Brightness: Scalar 0.0 to 1.0 (Careful with heat at 1.0!)
...
try:
    while True:
        ...
        # Enforce the time step (Delta t) to control speed
